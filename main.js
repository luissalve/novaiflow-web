...
(function () {
  ...
  var I18N = {
    en: {
      ...
      meta_desc: 'NovAIFlow puts AI on your phones, WhatsApp, CRM and warehouse so work stops living in Excel. Live in under 30 days. Bilingual EN/ES, Miami and LATAM.',
      ...
      hero_title: 'Your calls, WhatsApp and Excel <span class="accent">do not talk</span>. We leave them in one flow.',
      hero_lede: 'NovAIFlow installs AI on the phones, chats and systems you already run — so leads, jobs and inventory stop living in spreadsheets. Measurable, bilingual EN/ES, live in under 30 days.',
    ...
    es: {
      ...
      meta_desc: 'NovAIFlow pone IA en tus telefonos, WhatsApp, CRM y almacen para que el trabajo deje de vivir en Excel. En vivo en menos de 30 dias. Bilingue EN/ES, Miami y LATAM.',
      ...
      hero_title: 'Tus llamadas, WhatsApp y Excel <span class="accent">no se hablan</span>. Los dejamos en un solo flujo.',
      hero_lede: 'NovAIFlow instala IA en los telefonos, chats y sistemas que ya usas — para que leads, trabajos e inventario dejen de vivir en hojas de calculo. Medible, bilingue EN/ES, en vivo en menos de 30 dias.',
