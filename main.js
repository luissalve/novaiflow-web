...
(function () {
  ...
  var I18N = {
    en: {
      ...
      conv_l1: 'AUTOMATION', conv_l2: 'INTEGRATION', conv_l3: 'AI AGENTS', conv_l4: 'ANALYTICS', conv_l5: 'OPTIMIZATION', conv_lout: 'FLOW OF VALUE',
      ...
      case1_p: 'Corina AI runs 12+ specialized agents 24/7 — ticket triage, technician dispatch, billing and customer comms across WhatsApp, Telegram, voice and email — for a managed-print fleet of 3,000+ devices.',
      ...
      case2_p: 'VoxAI answers business lines for logistics, HVAC and healthcare clients — bilingual EN/ES agents with multi-destination PBX routing, guardrails and post-call actions. Provider migration with zero reported downtime.',
      ...
      port_lede: "We don't only build for clients — we run our own platforms on the same automated flow, as named nodes under the NovAIFlow umbrella.",
    ...
    es: {
      ...
      conv_l1: 'AUTOMATIZACIÓN', conv_l2: 'INTEGRACIÓN', conv_l3: 'AGENTES IA', conv_l4: 'ANALÍTICA', conv_l5: 'OPTIMIZACIÓN', conv_lout: 'FLUJO DE VALOR',
      ...
      case1_p: 'Corina AI corre 12+ agentes especializados 24/7 — triaje de tickets, despacho de técnicos, facturación y comunicación con clientes por WhatsApp, Telegram, voz y email — para una flota gestionada de 3,000+ equipos.',
      ...
      case2_p: 'VoxAI atiende líneas de negocio para clientes de logística, HVAC y salud — agentes bilingües EN/ES con enrutamiento a PBX multi-destino, guardrails y acciones post-llamada. Migración de proveedor sin downtime reportado.',
      ...
      port_lede: 'No solo construimos para clientes — operamos nuestras propias plataformas sobre el mismo flujo automatizado, como nodos con nombre bajo el paraguas NovAIFlow.',
